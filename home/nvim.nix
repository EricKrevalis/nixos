...
{
  # the target writes only into programs.neovim, a wrapper unused here
  stylix.targets.neovim.enable = false;

  # palette as lua data, lua/plugins/colorscheme.lua feeds it to base16-nvim
  xdg.dataFile."nvim/stylix-colors.lua".text =
